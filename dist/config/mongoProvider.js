...
export class MongoConfigProvider {
    opts;
    constructor(opts) {
        this.opts = opts;
    }
            ...
            return {
                ...
                sinks: {
                    ...
                    file: {
                        ...
                        filePath: String(doc.sinks?.file?.filePath || './logs/app-%DATE%.log'),
                    ...
                    graylog: {
                        ...
                        minLevel: normalizeLevel(doc.sinks?.graylog?.minLevel || globalLevel),
